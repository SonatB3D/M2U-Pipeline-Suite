M2U PIPELINE SUITE
Free to Use - Maya to Unreal Static Mesh Preflight, Prep, Validation and Export Toolkit
...
Watch the official introduction video for **M2U Pipeline Suite v1.0.8**:

<p align="center">
  <a href="https://www.youtube.com/watch?v=5_MOvFh39qM" target="_blank">
    <img
      src="https://img.youtube.com/vi/5_MOvFh39qM/maxresdefault.jpg"
      alt="M2U Pipeline Suite v1.0.8 Introduction Video"
      width="900"
    >
  </a>
</p>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=5_MOvFh39qM">
    ▶ Watch on YouTube
  </a>
</p>
...
<table>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up2.png" alt="Dashboard - 1685x901" width="100%">
      <br>
      <strong>Dashboard / Wizard</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up3.png" alt="Wizard Flow - 1686x920" width="100%">
      <br>
      <strong>Four-step workflow</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up4.png" alt="Validation Rules - 1686x920" width="100%">
      <br>
      <strong>Validation rules</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up5.png" alt="Pivot and Grid Checks - 1799x933" width="100%">
      <br>
      <strong>Pivot and grid checks</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up7.png" alt="Safe Fix Options - 1539x759" width="100%">
      <br>
      <strong>Safe fix options</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up8.png" alt="Collision Workflow - 1648x855" width="100%">
      <br>
      <strong>UCX collision workflow</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up9.png" alt="Asset Analysis Results - 1648x883" width="100%">
      <br>
      <strong>Asset analysis results</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up10.png" alt="Detailed Reports - 1485x923" width="100%">
      <br>
      <strong>Detailed validation reports</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up11.png" alt="Revalidation - 1671x869" width="100%">
      <br>
      <strong>Revalidation after cleanup</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up12.png" alt="Fixed Actions - 1423x862" width="100%">
      <br>
      <strong>Fixed actions log</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up13.png" alt="Export FBX and Reports - 1423x862" width="100%">
      <br>
      <strong>FBX export and reports</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up14.png" alt="Exported Mesh and UCX Preview - 1413x648" width="100%">
      <br>
      <strong>Exported mesh and UCX preview</strong>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up15.png" alt="HTML Report Overview - 1900x931" width="100%">
      <br>
      <strong>HTML QA report</strong>
    </td>
    <td width="50%">
      <img src="./m2u%20pipeline%20suite%20images/m2up18.png" alt="Readiness Checks - 1779x932" width="100%">
      <br>
      <strong>LOD / Material / UV / Socket readiness</strong>
    </td>
  </tr>
</table>
